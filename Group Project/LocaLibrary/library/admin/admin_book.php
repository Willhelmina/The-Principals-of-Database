...
<body>
   ...
   $page = ($pageVal-1)*$pageSize;
    ...
    <div class="container-fluid">
        ...
        <form method="POST" action="select_book.php" >
            <div class="form-inline">
                <div class="form-group">
                    <input type="text" id="input" class="form-control" placeholder="输入(编码/书名/类别）" name="keyword" style="width:130px;">
                </div>
                <div class="form-group">
        ...
        <a class="btn btn-info pull-right" href="add_book.php" style="margin:15px 10px 10px;">添加图书</a>
...
if(isset($_POST["keyword"]))
		{  
			...
			$sql = "select `bookcode`,`name`,`author`,`status` FROM book WHERE `bookcode`='{$query}' or `name`='{$query}'";
	      ...
	      $result = mysqli_query($conn,"select `bookcode`,`name`,`author`,`status` FROM book limit $page,$pageSize");
		//}
		if($pageVal <=3){
			$begin =1;
